      ...
      <div class="re-main">
                ...
                <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                    ...
                    <el-form-item label="验证码：" prop="code">
                       ...
                       <el-input v-model="ruleForm.code"></el-input>
                        ...
                        <el-col :span="4" id="change1" style="font-size:12px;color: #ADADAD;text-decoration: underline;"  ><span @click="changecode()">换一张</span></el-col>
                    </el-form-item>
                     <el-form-item label="短信验证码" prop="phonecode">
                      ...
                      <el-input v-model="ruleForm.checkPhoneCode"></el-input>
                       ...
                       <el-col :span="8">
                          <button @click="sendphonecode" class="sendphonecode" style="width:120px;height:40px;border: 1px solid #d7d7d7;font-size:12px;background-color: #f2f2f2;color: #323232;">获取验证码</button>
                       </el-col>
                    </el-form-item>
                    <el-form-item>
                ...
                <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                    ...
                    <el-form-item label="验证码：" prop="code1">
                       ...
                       <el-input v-model="ruleForm.code1"></el-input>
                        ...
                        <el-col :span="4" id="change1" style="font-size:12px;color: #ADADAD;text-decoration: underline;"  ><span id="codesubmit" @click="changecode1()">换一张</span></el-col>
                    </el-form-item>
                    <el-form-item>
                       <el-button type="primary" @click="submitForm('ruleForm')">注册</el-button>
                       <el-button @click="resetForm('ruleForm')">重置</el-button>
          ...
          <div class="main-right">
            <div class="inner">
                        ...
                        <div class="block clearfix">
                                ...
                                <div class="login-block clearfix">
                                    <div class="icon-logo">
                                        <a href="javascript:void(0)" name="third_login">
                                            <img src="../assets/img/register5-icon1.jpg" style="cursor: pointer;" width="54" height="54">
                                        </a>
                                    </div>
                            ...
                            <div class="login-block-shade left">
                                <div class="login-block clearfix">
                                    <div class="icon-logo">
                                        <a href="javascript:void(0)" name="third_login">
                                            <img src="../assets/img/register5-icon2.jpg" style="cursor: pointer;" width="54" height="54">
                                        </a>
                                    </div>
                                    <div class="icon-name" style="cursor: pointer;">
                            ...
                            <div class="login-block-shade left">
                                <div class="login-block clearfix">
                                    <div class="icon-logo">
                                        <a href="javascript:void(0)" name="third_login">
                                            <img src="../assets/img/register5-icon3.jpg" style="cursor: pointer;" width="54" height="54">
                                        </a>
                                    </div>
                                    <div class="icon-name" style="cursor: pointer;">
                            ...
                            <div class="login-block-shade left">
                                <div class="login-block clearfix">
                                    <div class="icon-logo">
                                        <a href="javascript:void(0)" name="third_login">
                                            <img src="../assets/img/register5-icon4.jpg" style="cursor: pointer;" width="54" height="54">
                                        </a>
                                    </div>
                                    <div class="icon-name" style="cursor: pointer;">
                    ...
                    <div class="tiaozhuan">
                        已有账号，<a href="javascript:void(0)">快速登录>></a>
                    </div>
          </div>
    ...
    methods: {
      ...
      changecode(){
		...
		for(let i=0;i<20;i++){
			...
			ctx.arc(randomNumber(0,width),randomNumber(0,height),1,2*Math.PI,true)
			ctx.closePath()
			ctx.stroke()
        }
        ...
        for(let i=0;i<4;i++){		
			...
			ctx.fillText(str,randomNumber((i+1)*10,(i+1)*15),randomNumber(20,height-20))
			this.allstr += str;		
        }
      ...
      changecode1(){    
        ...
        for(let i=0;i<20;i++){
			...
			ctx1.arc(randomNumber(0,width),randomNumber(0,height),1,2*Math.PI,true)
			ctx1.closePath()
			ctx1.stroke()
		}
        ...
        for(let i=0;i<4;i++){		
			...
			ctx1.fillText(str1,randomNumber((i+1)*10,(i+1)*15),randomNumber(20,height-20))
			this.allstr1 += str1;		
        }
